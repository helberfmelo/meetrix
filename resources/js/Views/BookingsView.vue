    ...
    <div class="space-y-12 animate-in fade-in duration-1000">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            ...
            <div class="flex gap-4">
                <button class="px-6 py-3 bg-white dark:bg-zinc-900 border border-black/5 dark:border-white/5 rounded-full text-[10px] font-black text-slate-500 uppercase tracking-widest hover:text-zinc-950 dark:hover:text-white hover:border-meetrix-orange/30 transition-all shadow-sm">
                    Export_CSV
                </button>
            </div>
        </div>
                        ...
                        <tr v-if="bookings.length === 0">
                            <td colspan="4" class="px-12 py-24 text-center">
                                <div class="flex flex-col items-center gap-6">
                                    <div class="w-16 h-16 rounded-full bg-zinc-100 dark:bg-zinc-900 flex items-center justify-center text-zinc-300 dark:text-zinc-800">
                                        📅
                                    </div>
