...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $page = SchedulingPage::updateOrCreate(
            ['user_id' => $user->id, 'slug' => 'helber'],
            [
        ...
        AppointmentType::updateOrCreate(
            ['scheduling_page_id' => $page->id, 'name' => 'Quick Chat'],
            [
                'duration_minutes' => 15,
                'price' => 0,
                'currency' => 'BRL',
        ...
        AppointmentType::updateOrCreate(
            ['scheduling_page_id' => $page->id, 'name' => 'Consultation'],
            [
                'duration_minutes' => 60,
                'price' => 150.00,
                'currency' => 'BRL',
        ...
        $this->command->info('User: admin@meetrix.pro / MeetrixMaster2026Sovereign!#');
